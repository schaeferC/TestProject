...
public class OneNews extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		LehrkraftNews newsToShow = new LehrkraftNews(DataSaver.readSettings(
				BeuthOrgApplication.getAppContext(), "news.json"));

		String[] result = newsToShow.getLehrkraftnewsByKey(getIntent()
				.getStringExtra("news"));
